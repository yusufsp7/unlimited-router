        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Install Unlimited Router, configure your providers via web dashboard, and start routing AI requests.
            </p>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#2a2a44] shadow-2xl">
              {/* Terminal header */}
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div 
                  ...
                  onClick={() => handleCopy("npx github:yusufsp7/unlimited-router")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">npx github:yusufsp7/unlimited-router</span>
