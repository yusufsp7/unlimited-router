...
export default function Footer() {
  return (
    <footer className="border-t border-[#2a2a44] bg-[#0f0f1e] pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a className="text-gray-400 hover:text-white transition-colors" href="https://github.com/yusufsp7/unlimited-router" target="_blank" rel="noopener noreferrer">
        ...
        {/* Bottom */}
        <div className="border-t border-[#2a2a44] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm">© 2025 Unlimited Router. All rights reserved.</p>
          <div className="flex gap-6">
            <a className="text-gray-600 hover:text-white text-sm transition-colors" href="https://github.com/yusufsp7/unlimited-router" target="_blank" rel="noopener noreferrer">GitHub</a>
