    ...
    <div className={cn("flex flex-col gap-1.5", className)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            "w-full py-2.5 px-4 text-sm text-text-main bg-surface-2 rounded-[14px] ring-1 ring-border-subtle focus-visible:ring-2 focus-visible:ring-brand-500/60 transition-shadow",
